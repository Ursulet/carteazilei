    ...
    <form onSubmit={handleSubmit} className="grid gap-6">
      ...
      <FormSection title="Identitate și flux editorial" description="Datele canonice ale operei și starea ei în circuitul editorial.">
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <label className={labelClass}>Nivelul evaluării: 0–100<input name="editorialConfidence" type="number" min="0" max="100" required defaultValue={values.editorialConfidence ?? 0} className={fieldClass} /></label>
        </div>
      </FormSection>

    ...
    return (
      <section className="py-16 md:py-24 lg:py-28">
        <div className="mx-auto w-full max-w-3xl px-5 sm:px-6">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-muted">Răspunde la câteva întrebări despre ce ai vrea să citești acum.</p>
          <div className="mt-10">

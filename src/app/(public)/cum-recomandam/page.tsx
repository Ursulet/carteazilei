...
export default function MethodologyPage() {
  return (
    <TrustPage eyebrow="Cum funcționează" title="O recomandare care pornește de la tine" intro="Ne uităm la ce ai chef să citești acum, la ritmul preferat și la lucrurile pe care vrei să le eviți." path="/cum-recomandam">
      ...
      <section><h2>Recomandarea personalizată</h2><p className="mt-4">Răspunsurile tale sunt comparate cu genul, temele, ritmul, lungimea și atmosfera cărților din catalog. Primești cartea care se potrivește cel mai bine și, când există, câteva alternative apropiate.</p></section>
